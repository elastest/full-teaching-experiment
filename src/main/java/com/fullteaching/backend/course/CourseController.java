...
public class CourseController {
	...
	public ResponseEntity<Object> getCourse(@PathVariable(value = "id") String id) {
		...
		Course course = courseRepository.findById(id_i).get();
	...
	public ResponseEntity<Object> newCourse(@RequestBody Course course) {
		 ...
		 * Course-Teacher, Course-User, Course-CourseDetails. Teacher, User and
		 * CourseDetails tables don't need to be updated (they will automatically be)
		 */
	...
	public ResponseEntity<Object> addAttenders(@RequestBody String[] attenderEmails,
		...
		if (teacherAuthorized != null) { // If the user is not the teacher of the course
			...
			log.info(
					"Attenders added: {} | Attenders already exist: {} | Emails not valid: {} | Emails valid but no registered: {}",
					customResponse.attendersAdded, customResponse.attendersAlreadyAdded, customResponse.emailsInvalid,
